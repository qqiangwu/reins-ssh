...
/**
 * NewsViewRankMonthId generated by hbm2java
 */
public class NewsViewRankMonthId implements java.io.Serializable {
    ...
    public NewsViewRankMonthId() {
    }

    public NewsViewRankMonthId(int newsId, String status, Date addtime,
                               Date updatetime) {
        this.newsId = newsId;
        this.status = status;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof NewsViewRankMonthId))
            return false;
        NewsViewRankMonthId castOther = (NewsViewRankMonthId) other;
