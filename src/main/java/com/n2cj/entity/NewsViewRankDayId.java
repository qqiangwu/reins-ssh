...
/**
 * NewsViewRankDayId generated by hbm2java
 */
public class NewsViewRankDayId implements java.io.Serializable {
    ...
    public NewsViewRankDayId() {
    }

    public NewsViewRankDayId(int newsId, String status, Date addtime,
                             Date updatetime) {
        this.newsId = newsId;
        this.status = status;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof NewsViewRankDayId))
            return false;
        NewsViewRankDayId castOther = (NewsViewRankDayId) other;
