...
/**
 * NewsForwardId generated by hbm2java
 */
public class NewsForwardId implements java.io.Serializable {
    ...
    public NewsForwardId() {
    }

    public NewsForwardId(int userId, int newsId, String status, Date addtime,
                         Date updatetime) {
        this.userId = userId;
        this.newsId = newsId;
        this.status = status;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof NewsForwardId))
            return false;
        NewsForwardId castOther = (NewsForwardId) other;
