...
/**
 * UserroleUserauthorityRelId generated by hbm2java
 */
public class UserroleUserauthorityRelId implements java.io.Serializable {
    ...
    public UserroleUserauthorityRelId() {
    }

    public UserroleUserauthorityRelId(int roleId, int authorityId,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof UserroleUserauthorityRelId))
            return false;
        UserroleUserauthorityRelId castOther = (UserroleUserauthorityRelId) other;
