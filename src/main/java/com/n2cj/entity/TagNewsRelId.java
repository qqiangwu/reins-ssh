...
/**
 * TagNewsRelId generated by hbm2java
 */
public class TagNewsRelId implements java.io.Serializable {
    ...
    public TagNewsRelId(int tagId, int newsId, String status, Date addtime,
                        Date updatetime) {
        this.tagId = tagId;
        this.newsId = newsId;
        this.status = status;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TagNewsRelId))
            return false;
        TagNewsRelId castOther = (TagNewsRelId) other;
